  ...
  return (
    <>
      <div className="bg-gray-900 flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-5 md:gap-5 items-start mx-auto w-full">
        <div className=" mt:2 md:px-5 relative w-1/5 md:w-full">
          <Sidebar
            onClick={() => collapseSidebar(!collapsed)}
            className="!sticky !w-[280px] bg-white-A700_05 border border-solid border-white-A700_14 flex h-screen md:hidden inset-[0] justify-center m-auto overflow-auto top-[0]"
          >
            <Img
              className="h-full mb-[884px] mt-8 w-[280px]"
            ...
            <Menu
              ...
              className="flex flex-col items-center justify-start mb-[149px] mt-[-850px] pt-2.5 sm:px-5 px-[30px] w-[79%]"
            >
              ...
              <div className="flex flex-col gap-[11px] items-center justify-end mt-[150px] w-full">
                <MenuItem
                  icon={
                    <Img
            ...
            {!collapsed && (
              <div className="flex flex-row items-center justify-between mb-[31px] mt-[-1080px] mx-4 px-2 w-[247px]">
        ...
        <div className="h-[1014px] md:px-5 relative w-[81%] md:w-full">
          ...
          />
          <div className="absolute bottom-[1%] flex flex-col gap-[22px] inset-x-[0] justify-start mx-auto w-full">
            <Line className="bg-white-A700_5e h-px w-full" />
          ...
          <div className="absolute flex flex-col inset-x-[0]  justify-start max-w-[1055px] mx-auto top-[14%] w-full">
            <div className="flex flex-col justify-start md:px-10 sm:px-5 px-[51px] w-full">
          ...
          <div className="absolute bottom-[8%] flex md:flex-col flex-row md:gap-[52px] inset-x-[0] items-center justify-between max-w-[1054px] mx-auto w-full">
            <div className="bg-white-A700_0a border border-solid border-white-A700_21 flex md:flex-1 flex-col items-center justify-start rounded-lg w-[50%] md:w-full">
              <div className="flex flex-col gap-3.5 items-center justify-start mb-4 mt-5 w-full">
            ...
            <div className="bg-white-A700_0a border border-solid border-white-A700_21 flex md:flex-1 flex-col gap-3 items-start justify-end py-[17px] rounded-lg w-[45%] md:w-full">
              <Text
